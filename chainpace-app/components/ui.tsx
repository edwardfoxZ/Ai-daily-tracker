...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-14 text-center">
      <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl border border-bordersoft bg-surface2 text-faint dark:border-bordersoft-dark dark:bg-surface2-dark">
        {icon}
      </div>
